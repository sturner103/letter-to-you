...
const AboutContent = () => (
  <div className="legal-section">
    ...
    <p className="legal-note">
      That's my personal experience. Yours will be different — and this tool isn't a 
...
const PrivacyContent = () => (
  <div className="legal-section">
    ...
    <h2>New Zealand Privacy Act</h2>
    <p>We comply with the Privacy Act 2020 (New Zealand). You have the right to request 
    access to, correction of, or deletion of your personal information. If you are not 
    satisfied with our response to a privacy concern, you may lodge a complaint with the 
    Office of the Privacy Commissioner at <a href="https://privacy.org.nz" target="_blank" rel="noopener noreferrer">privacy.org.nz</a>.</p>

    <h2>Legal Basis for Processing</h2>
    <p>We process your data on the basis of contract performance (providing the letter service 
    you requested) and legitimate interests (improving our service, fraud prevention). For 
    marketing communications, we rely on your consent, which you may withdraw at any time.</p>
...
const TermsContent = () => (
  <div className="legal-section">
    ...
    generated letter), refunds are not provided once a letter has been generated. If you 
    experience a technical failure that prevents letter delivery, contact us within 7 days 
    for assistance.</p>
    ...
    <p>You represent that you have the right to share the content you provide during 
    reflections, and that it does not infringe any third party's intellectual property 
    or privacy rights.</p>
    ...
    <p>We do not store flagged content differently from other content, and we do not contact 
    authorities or third parties based on your responses unless legally required to do so.</p>

    <h2>8. AI-Generated Content</h2>
    <p>Letters are generated by AI and may contain errors, misinterpretations of your input, 
    inconsistencies, or suggestions that are not appropriate for your specific circumstances. 
    The letters are meant as a reflective tool, not as factual statements, professional advice, 
    or guidance to follow. We do not guarantee the accuracy or suitability of AI-generated content.</p>
    <p>You are solely responsible for evaluating the content of your letter and deciding how to 
    act on it. We strongly recommend treating your letter as a starting point for self-reflection, 
    not as a directive. We make no claims about the therapeutic, psychological, or medical 
    benefits of using this Service.</p>
    ...
    your account at any time by contacting us. Upon account closure, your personal data 
    will be deleted within 30 days unless we are required by law to retain it.</p>
    ...
    <p>You agree to indemnify and hold harmless Letter to You and its operators from any 
    claims, damages, or expenses arising from your misuse of the Service or violation of 
    these Terms.</p>

    <h2>17. Severability</h2>
    <p>If any provision of these Terms is found to be unenforceable, the remaining provisions 
    will continue in full force and effect.</p>

    <h2>18. Force Majeure</h2>
    <p>We shall not be liable for any failure to perform due to circumstances beyond our 
    reasonable control, including but not limited to natural disasters, internet outages, 
    or third-party service failures.</p>
  </div>
);
